...
% --------------------------------------------------- %
\newcommand{\TituloDoTCC}{\uppercase{Desenvolvimento de Algoritmos de Planejamento e Controle para Navegação autônoma de Robôs Móveis em Tarefas Cooperativas de Mapeamento}}
...
\newcommand{\DataApresentacao}{Setembro/2024}
